...
import { Funnel, Timer, ArrowsClockwise, Star, CalendarBlank, Megaphone, CurrencyDollar } from '@phosphor-icons/react';
...
const SECTION_ICONS: Record<(typeof RAIL_SECTIONS)[number]['id'], React.ReactNode> = {
  ...
  'zone-money': <CurrencyDollar size={17} weight="regular" />,
